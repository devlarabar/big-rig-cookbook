        ...
        <section className="profile">
            <aside className="flex flex-col items-center">
                <h2 className="big-heading flex flex-center gap-2">
                    ...
                    {isViewersProfile && <Link href="/profile/settings"><button className="btn-profile-edit"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
